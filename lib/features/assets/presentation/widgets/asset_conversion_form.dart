...
class _SelectedAssetCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isForeignCurrency = definition.kind == AssetKind.foreignCurrency;

    final details = <String>[
      if (isForeignCurrency)
        definition.quoteSymbol ??
            '${definition.normalizedSymbol}/'
                '${definition.normalizedCurrencyCode}'
      else if (definition.normalizedSymbol != null)
        definition.normalizedSymbol!,
      if (!isForeignCurrency) definition.normalizedCurrencyCode,
      isForeignCurrency
          ? definition.normalizedUnit.toUpperCase()
